...
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.environ.get("SES_TOKEN_EXPIRE_MINUTES", "1440"))  # 24h
...
def hash_password(password: str) -> str:
    """Hash password with HMAC-SHA256 + random salt."""
...
def verify_password(password: str, hashed: str) -> bool:
    ...
    computed = hmac.new(salt.encode(), password.encode(), hashlib.sha256).hexdigest()
...
def register_user(username: str, password: str, email: str = "", display_name: str = "") -> dict:
